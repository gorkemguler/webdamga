...
_EN: dict[str, str] = {
    ...
    "cli.prune.help": "Delete captures older than N days (signed ones and monitor baselines are kept).",
    "cli.prune.opt.older_than": "Delete captures older than this many days",
    "cli.prune.opt.keep_signed": "Keep signed captures regardless of age",
    "cli.prune.opt.dry_run": "Show what would be deleted without deleting",
    "cli.prune.nothing": "Nothing old enough to delete.",
    "cli.prune.kept_signed": "kept {count} signed captures",
    "cli.prune.kept_baseline": "kept {count} monitor baselines",
    "cli.prune.dry_run": "Would delete {count} captures, freeing {mb} MB. Run without --dry-run to apply.",
    "cli.prune.done": "Deleted {count} captures, freed {mb} MB.",
    "cli.upgrade_ts.help": "Upgrade pending OpenTimestamps proofs as Bitcoin confirmations arrive.",
    "cli.upgrade_ts.no_client": "The ots client is not installed. Install it with: pip install opentimestamps-client",
    "cli.upgrade_ts.done": "Upgraded {upgraded}; still pending {pending}.",
    # --- Web, shared ---
    ...
    "cli.notify.help": "Send a test change notification to the configured channels.",
    "cli.notify.none": "No notification channel is configured. Set WEBDAMGA_WEBHOOK_URL or the SMTP variables.",
    "cli.notify.sample_reason": "A password field appeared (this is a test).",
    "web.monitors.notify": "Notifications",
    "web.monitors.notify.on": "on: {channels}",
    "web.monitors.notify.off": "off (set WEBDAMGA_WEBHOOK_URL or SMTP to enable)",
...
_TR: dict[str, str] = {
    ...
    "cli.prune.help": "N günden eski yakalamaları sil (imzalılar ve izleyici tabanları korunur).",
    "cli.prune.opt.older_than": "Bu kadar günden eski yakalamaları sil",
    "cli.prune.opt.keep_signed": "İmzalı yakalamaları yaşına bakmadan koru",
    "cli.prune.opt.dry_run": "Silmeden, nelerin silineceğini göster",
    "cli.prune.nothing": "Silinecek kadar eski bir şey yok.",
    "cli.prune.kept_signed": "{count} imzalı yakalama korundu",
    "cli.prune.kept_baseline": "{count} izleyici tabanı korundu",
    "cli.prune.dry_run": "{count} yakalama silinecek, {mb} MB boşalacak. Uygulamak için --dry-run olmadan çalıştır.",
    "cli.prune.done": "{count} yakalama silindi, {mb} MB boşaldı.",
    "cli.upgrade_ts.help": "Bekleyen OpenTimestamps kanıtlarını Bitcoin onayı geldikçe yükselt.",
    "cli.upgrade_ts.no_client": "ots istemcisi kurulu değil. Kurmak için: pip install opentimestamps-client",
    "cli.upgrade_ts.done": "{upgraded} yükseltildi; {pending} hâlâ bekliyor.",
    # --- Web, ortak ---
    ...
    "cli.notify.help": "Yapılandırılmış kanallara bir test bildirimi gönder.",
    "cli.notify.none": "Yapılandırılmış bildirim kanalı yok. WEBDAMGA_WEBHOOK_URL ya da SMTP değişkenlerini ayarla.",
    "cli.notify.sample_reason": "Bir parola alanı belirdi (bu bir testtir).",
    "web.monitors.notify": "Bildirimler",
    "web.monitors.notify.on": "açık: {channels}",
    "web.monitors.notify.off": "kapalı (açmak için WEBDAMGA_WEBHOOK_URL ya da SMTP ayarla)",
